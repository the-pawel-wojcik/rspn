...
def get_cc_j_singles_singles_aaaa(
    ...
    cc_j_singles_singles_aaaa +=  1.00 * einsum('kjbc,caik->aibj', g_aaaa[oa, oa, va, va], t2_aaaa)
    cc_j_singles_singles_aaaa +=  1.00 * einsum('jkbc,acik->aibj', g_abab[oa, ob, va, vb], t2_abab)
    cc_j_singles_singles_aaaa +=  0.50 * einsum('ij,lkbc,calk->aibj', kd_aa[oa, oa], g_aaaa[oa, oa, va, va], t2_aaaa, optimize=['einsum_path', (1, 2), (0, 1)])
    cc_j_singles_singles_aaaa += -0.50 * einsum('ij,lkbc,aclk->aibj', kd_aa[oa, oa], g_abab[oa, ob, va, vb], t2_abab, optimize=['einsum_path', (1, 2), (0, 1)])
    cc_j_singles_singles_aaaa += -0.50 * einsum('ij,klbc,ackl->aibj', kd_aa[oa, oa], g_abab[oa, ob, va, vb], t2_abab, optimize=['einsum_path', (1, 2), (0, 1)])
    cc_j_singles_singles_aaaa +=  0.50 * einsum('ab,kjcd,cdik->aibj', kd_aa[va, va], g_aaaa[oa, oa, va, va], t2_aaaa, optimize=['einsum_path', (1, 2), (0, 1)])
    cc_j_singles_singles_aaaa += -0.50 * einsum('ab,jkcd,cdik->aibj', kd_aa[va, va], g_abab[oa, ob, va, vb], t2_abab, optimize=['einsum_path', (1, 2), (0, 1)])
    cc_j_singles_singles_aaaa += -0.50 * einsum('ab,jkdc,dcik->aibj', kd_aa[va, va], g_abab[oa, ob, va, vb], t2_abab, optimize=['einsum_path', (1, 2), (0, 1)])
...
def get_cc_j_singles_singles_aabb(
    ...
    cc_j_singles_singles_aabb += -1.00 * einsum('kjcb,caik->aibj', g_abab[oa, ob, va, vb], t2_aaaa)
    cc_j_singles_singles_aabb += -1.00 * einsum('kjbc,acik->aibj', g_bbbb[ob, ob, vb, vb], t2_abab)
...
def get_cc_j_singles_singles_abab(
    ...
    cc_j_singles_singles_abab +=  1.00 * einsum('kjbc,acki->aibj', g_abab[oa, ob, va, vb], t2_abab)
    cc_j_singles_singles_abab +=  0.50 * einsum('ij,lkbc,calk->aibj', kd_bb[ob, ob], g_aaaa[oa, oa, va, va], t2_aaaa, optimize=['einsum_path', (1, 2), (0, 1)])
    cc_j_singles_singles_abab += -0.50 * einsum('ij,lkbc,aclk->aibj', kd_bb[ob, ob], g_abab[oa, ob, va, vb], t2_abab, optimize=['einsum_path', (1, 2), (0, 1)])
    cc_j_singles_singles_abab += -0.50 * einsum('ij,klbc,ackl->aibj', kd_bb[ob, ob], g_abab[oa, ob, va, vb], t2_abab, optimize=['einsum_path', (1, 2), (0, 1)])
    cc_j_singles_singles_abab += -0.50 * einsum('ab,kjcd,cdki->aibj', kd_aa[va, va], g_abab[oa, ob, va, vb], t2_abab, optimize=['einsum_path', (1, 2), (0, 1)])
    cc_j_singles_singles_abab += -0.50 * einsum('ab,kjdc,dcki->aibj', kd_aa[va, va], g_abab[oa, ob, va, vb], t2_abab, optimize=['einsum_path', (1, 2), (0, 1)])
    cc_j_singles_singles_abab +=  0.50 * einsum('ab,kjcd,cdik->aibj', kd_aa[va, va], g_bbbb[ob, ob, vb, vb], t2_bbbb, optimize=['einsum_path', (1, 2), (0, 1)])
...
def get_cc_j_singles_singles_baba(
    ...
    cc_j_singles_singles_baba +=  1.00 * einsum('jkcb,caik->aibj', g_abab[oa, ob, va, vb], t2_abab)
    cc_j_singles_singles_baba += -0.50 * einsum('ij,lkcb,calk->aibj', kd_aa[oa, oa], g_abab[oa, ob, va, vb], t2_abab, optimize=['einsum_path', (1, 2), (0, 1)])
    cc_j_singles_singles_baba += -0.50 * einsum('ij,klcb,cakl->aibj', kd_aa[oa, oa], g_abab[oa, ob, va, vb], t2_abab, optimize=['einsum_path', (1, 2), (0, 1)])
    cc_j_singles_singles_baba +=  0.50 * einsum('ij,lkbc,calk->aibj', kd_aa[oa, oa], g_bbbb[ob, ob, vb, vb], t2_bbbb, optimize=['einsum_path', (1, 2), (0, 1)])
    cc_j_singles_singles_baba +=  0.50 * einsum('ab,kjcd,cdik->aibj', kd_bb[vb, vb], g_aaaa[oa, oa, va, va], t2_aaaa, optimize=['einsum_path', (1, 2), (0, 1)])
    cc_j_singles_singles_baba += -0.50 * einsum('ab,jkcd,cdik->aibj', kd_bb[vb, vb], g_abab[oa, ob, va, vb], t2_abab, optimize=['einsum_path', (1, 2), (0, 1)])
    cc_j_singles_singles_baba += -0.50 * einsum('ab,jkdc,dcik->aibj', kd_bb[vb, vb], g_abab[oa, ob, va, vb], t2_abab, optimize=['einsum_path', (1, 2), (0, 1)])
...
def get_cc_j_singles_singles_bbaa(
    ...
    cc_j_singles_singles_bbaa += -1.00 * einsum('kjbc,caki->aibj', g_aaaa[oa, oa, va, va], t2_abab)
    cc_j_singles_singles_bbaa += -1.00 * einsum('jkbc,caik->aibj', g_abab[oa, ob, va, vb], t2_bbbb)
...
def get_cc_j_singles_singles_bbbb(
    ...
    cc_j_singles_singles_bbbb +=  1.00 * einsum('kjcb,caki->aibj', g_abab[oa, ob, va, vb], t2_abab)
    cc_j_singles_singles_bbbb +=  1.00 * einsum('kjbc,caik->aibj', g_bbbb[ob, ob, vb, vb], t2_bbbb)
    cc_j_singles_singles_bbbb += -0.50 * einsum('ij,lkcb,calk->aibj', kd_bb[ob, ob], g_abab[oa, ob, va, vb], t2_abab, optimize=['einsum_path', (1, 2), (0, 1)])
    cc_j_singles_singles_bbbb += -0.50 * einsum('ij,klcb,cakl->aibj', kd_bb[ob, ob], g_abab[oa, ob, va, vb], t2_abab, optimize=['einsum_path', (1, 2), (0, 1)])
    cc_j_singles_singles_bbbb +=  0.50 * einsum('ij,lkbc,calk->aibj', kd_bb[ob, ob], g_bbbb[ob, ob, vb, vb], t2_bbbb, optimize=['einsum_path', (1, 2), (0, 1)])
    cc_j_singles_singles_bbbb += -0.50 * einsum('ab,kjcd,cdki->aibj', kd_bb[vb, vb], g_abab[oa, ob, va, vb], t2_abab, optimize=['einsum_path', (1, 2), (0, 1)])
    cc_j_singles_singles_bbbb += -0.50 * einsum('ab,kjdc,dcki->aibj', kd_bb[vb, vb], g_abab[oa, ob, va, vb], t2_abab, optimize=['einsum_path', (1, 2), (0, 1)])
    cc_j_singles_singles_bbbb +=  0.50 * einsum('ab,kjcd,cdik->aibj', kd_bb[vb, vb], g_bbbb[ob, ob, vb, vb], t2_bbbb, optimize=['einsum_path', (1, 2), (0, 1)])
