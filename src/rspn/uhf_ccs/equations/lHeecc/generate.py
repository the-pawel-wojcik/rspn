...
def build_lHe1e1cc():
    ...
    pq.add_st_operator(-1., ['e1(a,i)', 'v', 'e1(b,j)'], ['t1'])
    pq.add_st_operator(-1., ['e1(b,j)', 'v', 'e1(a,i)'], ['t1'])
    pq.add_st_operator(1.0, ['e1(b,j)', 'e1(a,i)', 'v'], ['t1'])

    pq.add_st_operator(1.0, ['f', 'e1(a,i)', 'e1(b,j)'], ['t1'])
    pq.add_st_operator(-1., ['e1(a,i)', 'f', 'e1(b,j)'], ['t1'])
    pq.add_st_operator(-1., ['e1(b,j)', 'f', 'e1(a,i)'], ['t1'])
    pq.add_st_operator(1.0, ['e1(b,j)', 'e1(a,i)', 'f'], ['t1'])
